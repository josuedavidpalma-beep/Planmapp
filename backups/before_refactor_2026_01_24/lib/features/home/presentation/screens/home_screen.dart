        ...
        child: Column(
          ...
          children: [
            ...
            if (_selectedFilter == "Todo" || _selectedFilter == "Rumba")
                _buildContextCard(context, "Noche de Cócteles 🍸", "Zona T - Abierto ahora", "https://images.unsplash.com/photo-1572116469696-31de0f17cc34?auto=format&fit=crop&q=80&w=600"),
