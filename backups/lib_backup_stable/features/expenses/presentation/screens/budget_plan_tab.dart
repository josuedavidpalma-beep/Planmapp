...
class _BudgetPlanTabState extends State<BudgetPlanTab> {
  ...
  Future<void> _remindAll() async {
      ...
      // Encode for URL
      final message = "¡Hola equipo! 👋 Recordatorio de pago para '$_planTitle': \$${quota.toStringAsFixed(0)}. ${_deadline != null ? 'Límite: ${DateFormat('dd MMM').format(_deadline!)}' : ''}. ¡Gracias!";
  ...
  void _remindUser(PaymentTracker t) async {
       ...
       final message = "¡Hola ${t.displayName}! 👋 Recuerda realizar tu pago de \$${quota.toStringAsFixed(0)} para el plan '$_planTitle'. ${_deadline != null ? 'Fecha límite: ${DateFormat('dd MMM').format(_deadline!)}' : ''}. ¡Gracias!";
                             ...
                             Expanded(child: Column(
                                 ...
                                 children: [
                                     ...
                                     Container(
                                         ...
                                         child: Text("Cuota: \$${_quotaPerPerson.toStringAsFixed(0)} / pers", style: const TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.bold)),
                                     )
                                 ],
                             )),
                ...
                ..._budgetItems.map((item) => Card(
                    ...
                    child: ListTile(
                        ...
                        trailing: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Text("\$${item.estimatedAmount.toStringAsFixed(0)}", style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
