...
import 'package:planmapp/features/notifications/presentation/screens/notification_screen.dart';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      final isPublic = state.uri.path.startsWith('/join') || state.uri.path.startsWith('/invite') || state.uri.path == '/onboarding-setup';
